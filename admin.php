...
if (isset($_SESSION['admin'])) {
    ...
    if ($_POST['confirmSelect']) {
        $key = $_POST['select'];
        echo "<script language=\"javascript\">location='/admin.php/?para=" . $key . "';</script>";
    }
    if ($_POST['selectall']) {
        echo "<script language=\"javascript\">location='/admin.php/?para=';</script>";
    }
    ?>
    ...
    <html xmlns="http://www.w3.org/1999/xhtml">
        ...
        <body bgcolor="#E7D4D4" align="center">
            ...
            <form method="post">
                <div align="right">
                    <h3>管理员</h3>
                    <?php if ($_SESSION['admin'] == "admin") { ?><a href="/register.php">添加用户</a>|<?php } ?>
                                        ...
                                        <span>
                                            ...
                                            <input readonly="value" type="text" name="del[<?php echo $row[id]; ?>][parameter]" value="<?php echo $row['parameter'] ?>">
                                                ...
                                                <?php if ($num != 0) {
                                                    ...
                                                    <?php if ($_SESSION['admin'] == "admin") { ?><input type="submit" name="delete" value="删除"/><?php } ?>
